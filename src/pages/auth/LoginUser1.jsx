        ...
        <div>
            <div>
                ...
                <div className="min-h-screen bg-[#F3F0FF] flex items-center justify-center p-4 relative overflow-hidden">
                    ...
                    {/* Main Glass Card */}
                    <div className="relative z-10 w-full max-w-7xl flex flex-col lg:flex-row rounded-3xl overflow-hidden shadow-2xl shadow-indigo-200/30 bg-white/65 backdrop-blur-[16px] border border-white/35">
                        {/* LEFT - Branding Panel */}
                        <div className="relative lg:w-[48%] p-8 lg:p-12 flex flex-col justify-between bg-gradient-to-br from-[#6d28d9] via-[#a21caf] to-[#4338ca] text-white overflow-hidden">
                            {/* Decorative elements */}
                            ...
                            <div className="relative z-10">
                                {/* Logo - Using your requested logo with app image */}
                            ...
                            <div className="relative z-10 mt-12 lg:mt-0 flex items-center justify-between">
                        ...
                        {/* RIGHT - Login Form */}
                        <div className="lg:w-[52%] p-6 lg:p-10 flex items-center justify-center bg-white/30 backdrop-blur-sm">
                            <div className="w-full max-w-sm mx-auto">
                                ...
                                <form onSubmit={handleSubmit} className="space-y-5">
                                    <div>
                                        ...
                                        <div className="mt-1 relative">
                                            ...
                                            <input
                                                ...
                                                className="w-full h-12 pl-10 pr-4 rounded-xl text-gray-800 placeholder:text-gray-400 bg-white/60 backdrop-blur-sm border border-gray-200/50 focus:bg-white/90 focus:border-violet-300 focus:ring-4 focus:ring-violet-100 outline-none transition-all"
                                                required
                                            />
                                        </div>
                                    </div>
                                    ...
                                    <div>
                                        <div className="flex justify-between items-center">
                                            ...
                                            <a
                                                href="#"
                                                className="text-sm font-medium text-violet-600 hover:text-violet-800 transition flex items-center gap-1"
                                            >
                                                🔑 Forgot?
                                            </a>
                                        </div>
                                        <div className="mt-1 relative">
                                            ...
                                            <input
                                                ...
                                                onChange={handleChange}
                                                placeholder="••••••••"
                                                className="w-full h-12 pl-10 pr-14 rounded-xl text-gray-800 placeholder:text-gray-400 bg-white/60 backdrop-blur-sm border border-gray-200/50 focus:bg-white/90 focus:border-violet-300 focus:ring-4 focus:ring-violet-100 outline-none transition-all"
                                                required
                                            />
                                            <button
                                                type="button"
                                ...
                                <button className="w-full h-12 rounded-xl font-medium text-gray-700 flex items-center justify-center gap-3 transition-all bg-white/80 backdrop-blur-sm border border-gray-200/40 hover:bg-white hover:border-violet-300 hover:shadow-lg hover:shadow-violet-400/10">
                                    <img
                                ...
                                <div className="mt-6 flex items-center justify-center gap-1 text-[11px] text-gray-400/70">
